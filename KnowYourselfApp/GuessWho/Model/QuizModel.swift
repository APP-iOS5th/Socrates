...
let quizList: [QuizModel] = [
    QuizModel(question: "수업 중 약간 어려운 개념이 나왔다 나는...", answerOne: "이미 아는 내용이다! 수강생들을 돕는다", answerTwo: "채팅창으로 도움을 요청한다", answerThree: "챗지피티에게 도움을 요청한다"),
    QuizModel(question: "만두쌤이 화면공유를 깜빡하셨다 나는...", answerOne: "누군가 말해주길 기다린다", answerTwo: "채팅창으로 열심히 불러본다", answerThree: "마이크 켜고 말씀드린다"),
    ...
    QuizModel(question: "번개모임이 열렸다 나는...", answerOne: "빠질 수 없지 또 참석한다", answerTwo: "바쁘다 바빠 나는 집에서도 할 일이 많다!", answerThree: "번개 장소가 너무 멀다..ㅠ 강제불참"),
    QuizModel(question: "아프다던 팀원이 오늘 출석하지 않았다! 나는...", answerOne: "왜 안 오지? 사정이 있겠지 뭐", answerTwo: "많이 아프신가?ㅜㅜㅠㅠ", answerThree: "팀 채팅방에 태그해서 불러본다"),
    QuizModel(question: "더운 여름, 점심먹고 시간이 남아 카페에 왔다!\n나의 선택은?", answerOne: "아이스아메리카노", answerTwo: "따뜻한 커피", answerThree: "과일음료"),
    ...
    QuizModel(question: "만두쌤이 아아를 드시며 기침을 하신다 이때 나는...", answerOne: "차가운 음료 그만 드세요!", answerTwo: "목 상태가 안 좋아보여요 괜찮으신가요ㅜㅜ", answerThree: "아아와 기침은 상관이 없다!")
]
