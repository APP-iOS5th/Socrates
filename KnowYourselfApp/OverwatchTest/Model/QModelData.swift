...
var questions: [String :QModelData] = [
        ...
        "tanker0" : QModelData(question: """
                               ...
                               """,
                               anwser1: "팀의 전략을 세우고 논리적인 접근을 통해 문제를 분석하고 해결 방안을 제시합니다. 팀원들에게 지적인 자극을 주며, 철저한 계획을 통해 프로젝트를 이끕니다.",//(시그마),
        ...
        "tanker1" : QModelData(question: """
                               ...
                               """,
                               anwser1: "약육강식: 인생은 강한 자가 살아남는 곳이며, 자신의 실력을 키우고 경쟁에서 승리하는 것이 중요하다.",//퀸
                               anwser2: "평화: 인생은 조화와 평화가 중요하며, 선한 마음으로 서로를 도우며 살아가는 것이 중요하다.",//오리사
                               anwser3: "먹는게 전부: 인생은 맛있는 음식을 먹고, 즐기는 것이 가장 중요하며, 생존과 만족이 최우선이다.",//로드호그
                               anwser4: ""),
